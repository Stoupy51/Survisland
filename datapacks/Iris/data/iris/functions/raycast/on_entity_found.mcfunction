...
execute as @e[type=!#iris:ignore,type=!player, tag=!iris.executing, dx=0, dy=0, dz=0] run function iris:get_hitbox/entity
execute as @a[gamemode=adventure, tag=!iris.executing, dx=0, dy=0, dz=0] run function iris:get_hitbox/entity
