...
execute if score #success survisland.data matches 0 store success score #success survisland.data if data entity @s SelectedItem.tag{CustomModelData:2010010} run function survisland:parchemins/deploy_close
