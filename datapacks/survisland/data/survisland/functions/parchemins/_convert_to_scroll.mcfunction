...
setblock ~ ~-2 ~ air
setblock ~ ~-2 ~ oak_sign{Text1:'[{"text":"Auteur : ","color":"gold","italic":false},{"nbt":"Item.tag.author","storage":"survisland:main","interpret":false,"color":"yellow"}]',Text2:'[{"nbt":"Item.tag.pages[0]","storage":"survisland:main","interpret":true,"color":"red","italic":false}]'}

# Copy the author in the lore and the page content in the name
data modify storage survisland:main Item.tag.display.Lore append from block ~ ~-2 ~ Text1
data modify storage survisland:main Item.tag.display.Name set from block ~ ~-2 ~ Text2
