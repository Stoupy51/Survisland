...
tellraw @a ["\n",{"nbt":"Survisland","storage":"survisland:main","interpret":true},{"text":" Fin de l'épreuve avec une victoire de "},{"selector":"@a[tag=survisland.winner]"},{"text":" !\n"}]
...
clear @a warped_fungus_on_a_stick{quake:1b}
