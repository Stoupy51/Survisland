...
execute if score #mTuarua_buttons survisland.data matches 20 run data modify block -1251 51 -2788 auto set value 0b
execute if score #mTuarua_buttons survisland.data matches 20 run data modify block -1239 51 -2788 auto set value 0b
execute if score #mTuarua_buttons survisland.data matches 20 run data modify block -1227 51 -2788 auto set value 0b
execute if score #mTuarua_buttons survisland.data matches 20 run data modify block -1215 51 -2788 auto set value 0b
