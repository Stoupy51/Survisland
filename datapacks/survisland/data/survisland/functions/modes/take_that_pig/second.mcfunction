...
execute if score #detect_end survisland.data matches 0 if predicate survisland:chance/0.2 run summon pig -1220 64 -2806 {Tags:["survisland.to_take"],AbsorptionAmount:2048.0f}
execute if score #detect_end survisland.data matches 0 if predicate survisland:chance/0.1 run summon cow -1220 64 -2806 {Tags:["survisland.to_take"],AbsorptionAmount:2048.0f}
execute if score #detect_end survisland.data matches 0 if predicate survisland:chance/0.1 run summon horse -1220 64 -2806 {Tags:["survisland.to_take"],AbsorptionAmount:2048.0f}
execute if score #detect_end survisland.data matches 0 if predicate survisland:chance/0.1 run summon chicken -1220 64 -2806 {Tags:["survisland.to_take"],AbsorptionAmount:2048.0f}
