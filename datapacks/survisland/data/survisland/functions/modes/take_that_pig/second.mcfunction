...
execute if score #detect_end survisland.data matches 1 if score #good_2 survisland.data matches 1 as @a at @s run playsound entity.wither.ambient ambient @s 
