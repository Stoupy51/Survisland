...
execute if score @s survisland.temp.heart_beat matches 60 run playsound entity.warden.heartbeat ambient @s
...
execute if score @s survisland.temp.heart_beat matches 70 run playsound entity.warden.heartbeat ambient @s
execute if score @s survisland.temp.heart_beat matches 80 run playsound entity.warden.heartbeat ambient @s
execute if score @s survisland.temp.heart_beat matches 90 run playsound entity.warden.heartbeat ambient @s
