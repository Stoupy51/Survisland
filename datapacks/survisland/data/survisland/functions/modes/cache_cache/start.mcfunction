...
tellraw @a ["\n",{"nbt":"Survisland","storage":"survisland:main","interpret":true},{"text":" Lancement de l'épreuve, cachez-vous bien !"}]
...
team modify survisland.temp.sidebar.7 suffix [{"text":"emps restant : "},{"text":"15","color":"yellow"},{"text":"m"},{"text":"0","color":"yellow"},{"text":"s"}]
...
team modify survisland.temp.sidebar.7 color white
...
team join survisland.temp.sidebar.7 T
...
scoreboard players set T survisland.temp.sidebar 7
