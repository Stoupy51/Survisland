...
execute if score #intro survisland.data matches 315 run summon firework_rocket ~ ~15.75 ~ {LifeTime:0,FireworksItem:{id:"firework_rocket",Count:1b,tag:{Fireworks:{Explosions:[{Type:1,Flicker:1,Trail:1,Colors:[I;16777215],FadeColors:[I;16777215]}]}}}}
execute if score #intro survisland.data matches 315 run summon firework_rocket ~ ~15.75 ~ {LifeTime:0,FireworksItem:{id:"firework_rocket",Count:1b,tag:{Fireworks:{Explosions:[{Type:1,Flicker:1,Trail:1,Colors:[I;16777215],FadeColors:[I;16777215]}]}}}}
execute if score #intro survisland.data matches 315 at @a[gamemode=!spectator] run summon firework_rocket ~ ~15.75 ~ {LifeTime:0,FireworksItem:{id:"firework_rocket",Count:1b,tag:{Fireworks:{Explosions:[{Type:1,Flicker:1,Trail:1,Colors:[I;0],FadeColors:[I;0]}]}}}}
