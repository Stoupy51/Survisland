...
execute if score #state survisland.data matches 0 if score @s survisland.cooldown matches -50 if entity @a[distance=..1,tag=!survisland.moving_structure_immune] run function survisland:moving_structure/action_launch
...
# Move players
execute if score @s survisland.cooldown matches 1.. run function survisland:moving_structure/action_movement
