...
execute if score #state survisland.data matches 0 unless data entity @s data{is_auto:0} if score @s survisland.cooldown matches ..-50 if entity @a[distance=..1,tag=!survisland.moving_structure_immune,gamemode=!spectator] run function survisland:moving_structure/launch_timer
