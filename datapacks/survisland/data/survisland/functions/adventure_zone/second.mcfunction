...
execute as @a[tag=survisland.in_adv_zone] at @s unless entity @e[type=marker,tag=survisland.adventure_zone,distance=..250] unless entity @e[type=marker,tag=survisland.small_adventure_zone,distance=..250] run function survisland:adventure_zone/leave
