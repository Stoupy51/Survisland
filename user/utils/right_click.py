...
def main() -> None:
	...
	cushion_item_model: str = cushion.components["item_model"]
...
execute if score #success {ns}.data matches 0 store success score #success {ns}.data if data entity @s SelectedItem.components{{"minecraft:item_model":"{cushion_item_model}"}} run function {ns}:cushion/place
