...
def main(config: dict) -> dict[str, dict]:
	...
	database: dict[str,dict] = {
		...
		"maracas": {
			...
			"equippable":{"slot":"head","equip_sound":{"sound_id":"survisland:maracas"}},
