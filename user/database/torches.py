	...
	Item(
		...
		override_model={
			...
			"display": {
				...
				"fixed": { "translation": [0, 4, 0], "scale": [1.5, 1.5, 1.5] }
			},
			"groups": [
				0, 1, 2,
				{"name": "side", "origin": [8, 0, 8], "color": 0, "nbt": "{}", "armAnimationEnabled": False, "children": [3, 4]},
				{"name": "side", "origin": [8, 0, 8], "color": 0, "nbt": "{}", "armAnimationEnabled": False, "children": [5, 6]},
				{"name": "side", "origin": [8, 0, 8], "color": 0, "nbt": "{}", "armAnimationEnabled": False, "children": [7, 8]},
				{"name": "side", "origin": [8, 0, 8], "color": 0, "nbt": "{}", "armAnimationEnabled": False, "children": [9, 10]}
			]
		}
	)
