...
tag @p[predicate=switch:has_same_id] add survisland.temp
...
execute if score #particle_effect survisland.data matches 1 run particle glow ~ ~ ~ 0.2 0.2 0.2 0 2
execute if score #particle_effect survisland.data matches 2 run particle happy_villager ~ ~ ~ 0.2 0.2 0.2 0 2
