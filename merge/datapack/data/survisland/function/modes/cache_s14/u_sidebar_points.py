...
for i in range(-100, 5001, 10):
	file.write(f"""execute if score #mPonogoro_points survisland.data matches {i} run team modify survisland.temp.sidebar.7 suffix [{{"text":"Points : ","color":"light_purple"}},{{"text":"{i}","color":"gray"}}]\n""")
