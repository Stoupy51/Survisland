...
execute if score #state survisland.data matches 1 store result storage survisland:main positioned.x int 1 run scoreboard players get #dest_x survisland.data
execute if score #state survisland.data matches 1 store result storage survisland:main positioned.y int 1 run scoreboard players get #dest_y survisland.data
