...
#> survisland:calls/furnace_nbt_recipes/smelting_recipes
#
...
execute if score #found furnace_nbt_recipes.data matches 0 store result score #found furnace_nbt_recipes.data if data storage furnace_nbt_recipes:main input{"id": "minecraft:bread"} run loot replace block ~ ~ ~ container.3 loot survisland:i/croissant
