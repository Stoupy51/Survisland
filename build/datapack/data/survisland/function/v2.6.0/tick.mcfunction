...
#> survisland:v2.6.0/tick
#
# @within	survisland:v2.6.0/load/tick_verification
#

# Timers
scoreboard players add #second survisland.data 1
scoreboard players add #minute survisland.data 1
execute if score #second survisland.data matches 20.. run function survisland:v2.6.0/second
execute if score #minute survisland.data matches 1200.. run function survisland:v2.6.0/minute
