...
#> survisland:v2.1.3/load/enumerate
#
...
execute if score #survisland.major load.status matches 2 if score #survisland.minor load.status matches 1 unless score #survisland.patch load.status matches 3.. run scoreboard players set #survisland.patch load.status 3
