...
#> survisland:v2.1.3/load/valid_dependencies
#
# @within	survisland:v2.1.3/load/secondary
#			survisland:v2.1.3/load/valid_dependencies 1t replace
#

# Waiting for a player to get the game version, but stop function if no player found
execute unless entity @p run schedule function survisland:v2.1.3/load/valid_dependencies 1t replace
