...
tellraw @a ["\n",{"nbt":"Survisland","storage":"survisland:main","interpret":true},{"translate": "survisland.lancement_de_lpreuve_de_snk_lab_bonne_chance"}]

scoreboard objectives add survisland.temp.sidebar dummy {"translate": "survisland.progression","color":"yellow"}
...
team modify survisland.temp.sidebar.2 suffix [{"translate": "survisland.kijan","color":"dark_aqua"},{"text":"0","color":"yellow"},{"text":"%","color":"gray"}]
team modify survisland.temp.sidebar.1 suffix [{"translate": "survisland.ainy","color":"green"},{"text":"0","color":"yellow"},{"text":"%","color":"gray"}]
