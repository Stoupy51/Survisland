...
tellraw @a ["\n",{"nbt":"Survisland","storage":"survisland:main","interpret":true},{"text":" Progrès de l'équipe "},{"text":"Ijo","color":"dark_purple"},{"text":" : "},{"text":"[","color":"aqua"},{"score":{"name":"#mIjo","objective":"survisland.data"},"color":"yellow"},{"text":"/"},{"text":"6","color":"yellow"},{"text":"]","color":"aqua"}]
...
execute if score #mIjo survisland.data matches 6 if score #diso_pos survisland.data matches 1 run tellraw @a ["\n",{"nbt":"Survisland","storage":"survisland:main","interpret":true},{"text":" L'équipe "},{"text":"Ijo","color":"dark_purple"},{"text":" vient de terminer "},{"score":{"name":"#diso_pos","objective":"survisland.data"},"color":"aqua"},{"text":"ère"}]
execute if score #mIjo survisland.data matches 6 if score #diso_pos survisland.data matches 2.. run tellraw @a ["\n",{"nbt":"Survisland","storage":"survisland:main","interpret":true},{"text":" L'équipe "},{"text":"Ijo","color":"dark_purple"},{"text":" vient de terminer "},{"score":{"name":"#diso_pos","objective":"survisland.data"},"color":"aqua"},{"text":"ème"}]
