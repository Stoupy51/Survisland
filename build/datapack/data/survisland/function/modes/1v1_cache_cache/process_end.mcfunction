...
execute if score #process_end survisland.data matches 1 run function survisland:modes/1v1_cache_cache/update_sidebar_points with storage survisland:main cache_cache_config
...
execute if score #process_end survisland.data matches 1 run schedule clear survisland:modes/1v1_cache_cache/second
...
$execute if score #process_end survisland.data matches 1 run gamemode spectator @a[team=!$(team1_id),team=!$(team2_id),gamemode=!creative]
...
execute if score #process_end survisland.data matches 6000 run function survisland:modes/1v1_cache_cache/stop
