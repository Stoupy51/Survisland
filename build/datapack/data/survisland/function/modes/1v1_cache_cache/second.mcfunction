...
#
# @within	survisland:modes/1v1_cache_cache/macro_start 20t replace
#			survisland:modes/1v1_cache_cache/second 20t replace
#
...
execute if score #1v1_cache_cache_seconds survisland.data matches 590 run tellraw @a ["",{"nbt":"SurvislandWarning","storage":"survisland:main","interpret":true},{"translate": "survisland.lancement_de_leffet_glowing_priodique_dans_10_secondes_1m00s"}]
