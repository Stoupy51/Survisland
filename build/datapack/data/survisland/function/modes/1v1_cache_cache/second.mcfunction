...
#> survisland:modes/1v1_cache_cache/second
#
# @within	survisland:modes/1v1_cache_cache/macro_start 20t replace [ scheduled ]
#			survisland:modes/1v1_cache_cache/second 20t replace [ scheduled ]
#

##Fonction executée toutes les secondes lorsque le mode de jeu est activé

schedule function survisland:modes/1v1_cache_cache/second 20t replace
scoreboard players add #1v1_cache_cache_seconds survisland.data 1
...
execute if score #1v1_cache_cache_seconds survisland.data matches 590 run tellraw @a ["",{"nbt":"SurvislandWarning","storage":"survisland:main","interpret":true},{"text":" Lancement de l'effet glowing périodique dans 10 secondes (1m00s) !"}]
