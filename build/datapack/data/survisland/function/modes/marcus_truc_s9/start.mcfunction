...
scoreboard objectives add sidebar dummy {"translate": "survisland.scores","color":"gold"}
...
data modify storage survisland:main compteur set value {decompte:5,sounds:{xp:1b,goat_horn:1b,wither:0b},title:[{"translate": "survisland.epreuve_de_confort","color":"aqua"},{"text":"#4","color":"light_purple"}]}
