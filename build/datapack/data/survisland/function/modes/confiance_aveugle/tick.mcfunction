...
#> survisland:modes/confiance_aveugle/tick
#
# @within	survisland:modes/confiance_aveugle/start 1t replace [ scheduled ]
#			survisland:modes/confiance_aveugle/tick 1t replace [ scheduled ]
#
