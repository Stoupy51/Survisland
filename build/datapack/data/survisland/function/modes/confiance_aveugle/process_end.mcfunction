...
#> survisland:modes/confiance_aveugle/process_end
#
...
execute if score #process_end survisland.data matches 1 if score #detect_end survisland.data matches 3 run tellraw @a ["\n",{"nbt":"Survisland","storage":"survisland:main","interpret":true},{"translate": "survisland.fin_de_lpreuve_de_confiance_aveugle_avec_une_victoire_de_lquipe_"},{"selector":"@a[team=mPeluang,sort=random]"}]
