...
#
# @within	survisland:modes/cache_s14/start 1t replace
#			survisland:modes/cache_s14/tick 1t replace
#
...
# Detection de mort
execute as @a[scores={survisland.temp.deathCount=1..}] run function survisland:modes/cache_s14/death
