...
#> survisland:modes/1v1v1_cache_cache/macro_tick
#
...
schedule function survisland:modes/1v1v1_cache_cache/tick 1t replace
scoreboard players add #1v1v1_cache_cache_ticks survisland.data 1

# Detection de mort
execute as @a[scores={survisland.temp.death_count=1..}] run function survisland:modes/1v1v1_cache_cache/death
execute as @e[type=player,tag=survisland.dead] at @s run function survisland:modes/1v1v1_cache_cache/death_teleport

# Heart beat
execute as @a[tag=survisland.alive] at @s run function survisland:modes/1v1v1_cache_cache/heart_beat
...
$execute if score #detect_end survisland.data matches 0 unless score #specs_restants survisland.data matches 0 store result score #specs_restants survisland.data if entity @a[team=!$(team3_id),team=!$(team2_id),team=!$(team1_id),tag=survisland.alive]
...
execute if score #detect_end survisland.data matches 0 run function survisland:modes/1v1v1_cache_cache/update_sidebar_alives with storage survisland:main cache_cache_config
execute if score #detect_end survisland.data matches 1.. run function survisland:modes/1v1v1_cache_cache/process_end with storage survisland:main cache_cache_config
