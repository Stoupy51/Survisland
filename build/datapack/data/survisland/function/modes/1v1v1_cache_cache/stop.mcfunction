...
#> survisland:modes/1v1v1_cache_cache/stop
#
# @within	survisland:modes/1v1v1_cache_cache/process_end
#
...
schedule clear survisland:modes/1v1v1_cache_cache/tick
schedule clear survisland:modes/1v1v1_cache_cache/second
