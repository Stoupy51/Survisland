...
$execute if score #process_end survisland.data matches 1 if score #$(team1_id)_points survisland.data = #$(team2_id)_points survisland.data if score #$(team2_id)_points survisland.data = #$(team3_id)_points survisland.data run scoreboard players set #detect_end survisland.data 3
