...
#> survisland:modes/1v1v1_cache_cache/macro_start
#
# @within	survisland:modes/1v1v1_cache_cache/start with storage survisland:main cache_cache_config
#
...
scoreboard players set #1v1v1_cache_cache_seconds survisland.data 0
scoreboard players set #1v1v1_cache_cache_ticks survisland.data 0
...
$team modify survisland.temp.sidebar.5 suffix [{"translate": "survisland.joueurs_restants","color":"$(team1_color)"},{"text":"0","color":"yellow"}]
...
$team modify survisland.temp.sidebar.2 suffix [{"translate": "survisland.joueurs_restants","color":"$(team2_color)"},{"text":"0","color":"yellow"}]
...
schedule function survisland:modes/1v1v1_cache_cache/second 20t replace
