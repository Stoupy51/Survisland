...
#> survisland:modes/take_that_pig/process_end
#
...
execute if score #process_end survisland.data matches 1 run clear @a fishing_rod[minecraft:custom_data={survisland:{temp:1b}}]
execute if score #process_end survisland.data matches 1 run clear @a netherite_sword[minecraft:custom_data={survisland:{temp:1b}}]
