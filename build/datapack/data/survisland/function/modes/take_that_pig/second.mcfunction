...
execute if score #detect_end survisland.data matches 0 if score #remaining_time survisland.data matches 1.. run title @a actionbar [{"translate": "survisland.temps_restant","color":"aqua"},{"score":{"name":"#remaining_time","objective":"survisland.data"},"color":"yellow"},{"translate": "survisland.secondes"}]
...
execute if score #detect_end survisland.data matches 0 if score #remaining_time survisland.data matches 60 run tellraw @a ["\n",{"nbt":"SurvislandWarning","storage":"survisland:main","interpret":true},{"translate": "survisland.incroyable_deux_spectateurs_sont_apparus_combien_de_points_peuve"}]
...
execute if score #detect_end survisland.data matches 0 if score #remaining_time survisland.data matches 0 as @e[tag=survisland.to_take] run data modify entity @s AbsorptionAmount set value 0.0f
...
execute if score #detect_end survisland.data matches 0 if score #remaining_time survisland.data matches 0 as @a at @s run playsound ui.toast.challenge_complete ambient @s
execute if score #detect_end survisland.data matches 0 if score #remaining_time survisland.data matches 0 run tellraw @a ["\n",{"nbt":"Survisland","storage":"survisland:main","interpret":true},{"translate": "survisland.premire_tape_termine_passez_la_deuxime"}]
...
##Killing mobs
execute if score #detect_end survisland.data matches 1 unless score #good survisland.data matches 1 run scoreboard players set #good survisland.data 1
...
execute if score #detect_end survisland.data matches 1 if score #good survisland.data matches 1 run tellraw @a ["\n",{"nbt":"SurvislandWarning","storage":"survisland:main","interpret":true},{"translate": "survisland.wtf_deux_autres_spectateurs_sont_apparus_zigouillez_les"}]
...
execute if score #detect_end survisland.data matches 1 unless entity @e[tag=survisland.to_take] unless entity @a[tag=survisland.to_take_spec] run scoreboard players set #good_2 survisland.data 1
execute if score #detect_end survisland.data matches 1 if score #good_2 survisland.data matches 1 run fill -1268 52 -2793 -1268 55 -2798 air replace emerald_block
execute if score #detect_end survisland.data matches 1 if score #good_2 survisland.data matches 1 run tellraw @a ["\n",{"nbt":"Survisland","storage":"survisland:main","interpret":true},{"translate": "survisland.deuxime_preuve_termine_plus_que_le_parcours_vous_avez_45_seconde"}]
execute if score #detect_end survisland.data matches 1 if score #good_2 survisland.data matches 1 as @a at @s run playsound ui.toast.challenge_complete ambient @s
execute if score #detect_end survisland.data matches 1 if score #good_2 survisland.data matches 1 run scoreboard players set #pos survisland.data 1
execute if score #detect_end survisland.data matches 1 if score #good_2 survisland.data matches 1 run scoreboard players set #mult survisland.data 110
execute if score #detect_end survisland.data matches 1 if score #good_2 survisland.data matches 1 run scoreboard players set #remaining_time survisland.data 45
...
##Parcours
execute if score #detect_end survisland.data matches 2 run title @a actionbar [{"translate": "survisland.temps_restant","color":"aqua"},{"score":{"name":"#remaining_time","objective":"survisland.data"},"color":"yellow"},{"translate": "survisland.secondes"}]
