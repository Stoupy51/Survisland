...
execute if score #process_end survisland.data matches 1 if score #detect_end survisland.data matches 4 run tellraw @a ["",{"nbt":"Survisland","storage":"survisland:main","interpret":true},{"translate": "survisland.avec_une_victoire_de_lquipe_kuning"},{"selector":"@a[team=mKuning,sort=random]"}]
execute if score #process_end survisland.data matches 1 if score #detect_end survisland.data matches 3 run tellraw @a ["",{"nbt":"Survisland","storage":"survisland:main","interpret":true},{"translate": "survisland.avec_une_victoire_de_lquipe_mayra"},{"selector":"@a[team=mMayra,sort=random]"}]
