...
#
# @within	survisland:modes/cache_s13/start 1t replace [ scheduled ]
#			survisland:modes/cache_s13/tick 1t replace [ scheduled ]
#
...
# Detection de mort
execute as @a[scores={survisland.temp.death_count=1..}] run function survisland:modes/cache_s13/death
