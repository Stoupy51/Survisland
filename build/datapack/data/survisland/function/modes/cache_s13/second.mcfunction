...
#
# @within	survisland:modes/cache_s13/second 20t replace [ scheduled ]
#			survisland:modes/cache_s13/start 20t replace [ scheduled ]
#

##Fonction executée toutes les secondes lorsque le mode de jeu est activé

schedule function survisland:modes/cache_s13/second 20t replace
scoreboard players add #cache_s13_seconds survisland.data 1
scoreboard players remove #remaining_time survisland.data 1
function survisland:modes/cache_s13/update_sidebar_points
function survisland:modes/cache_s13/update_sidebar_timer
...
execute if score #cache_s13_seconds survisland.data matches 590 run tellraw @a ["",{"nbt":"SurvislandWarning","storage":"survisland:main","interpret":true},{"text":" Lancement de l'effet glowing périodique dans 10 secondes (1m00s) !"}]
