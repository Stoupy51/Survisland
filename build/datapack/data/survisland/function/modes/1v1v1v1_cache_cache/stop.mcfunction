...
#> survisland:modes/1v1v1v1_cache_cache/stop
#
...
team remove survisland.temp.sidebar.14
team remove survisland.temp.sidebar.13
team remove survisland.temp.sidebar.12
team remove survisland.temp.sidebar.11
team remove survisland.temp.sidebar.10
team remove survisland.temp.sidebar.9
...
schedule clear survisland:modes/1v1v1v1_cache_cache/tick
schedule clear survisland:modes/1v1v1v1_cache_cache/second
