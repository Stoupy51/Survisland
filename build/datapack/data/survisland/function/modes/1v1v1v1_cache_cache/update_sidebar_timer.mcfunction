...
#> survisland:modes/1v1v1v1_cache_cache/update_sidebar_timer
#
# @within	survisland:modes/1v1v1v1_cache_cache/second
#
...
function survisland:modes/1v1v1v1_cache_cache/macro_update_sb_timer with storage survisland:main input
