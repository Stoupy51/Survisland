...
execute if score #cache_s16_seconds survisland.data matches 590 run tellraw @a ["",{"nbt":"SurvislandWarning","storage":"survisland:main","interpret":true},{"translate": "survisland.lancement_de_leffet_glowing_priodique_dans_10_secondes_1m00s"}]
