...
#
# @within	survisland:modes/cache_s16/start 1t replace
#			survisland:modes/cache_s16/tick 1t replace
#
...
# Detection de mort
execute as @a[scores={survisland.temp.deathCount=1..}] run function survisland:modes/cache_s16/death
