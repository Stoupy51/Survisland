...
#> survisland:modes/cache_s16/stop
#
# @within	survisland:modes/cache_s16/process_end
#
...
schedule clear survisland:modes/cache_s16/tick
schedule clear survisland:modes/cache_s16/second
