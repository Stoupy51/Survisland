...
execute as @a[tag=survisland.all_together] if score @s survisland.all_together.group = @n[type=mannequin,tag=survisland.all_together.body] survisland.all_together.group run function survisland:modes/all_together/body/deal/fort
