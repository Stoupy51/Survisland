...
#> survisland:modes/all_together/body/deal/prologue
#
# @executed	as @a[tag=survisland.all_together,distance=..50]
#
# @within	survisland:modes/all_together/body/set_phase/prologue [ as @a[tag=survisland.all_together,distance=..50] ]
#
...
execute if score @s survisland.all_together matches 3 run tag @s add survisland.all_together.forward
...
execute if score @s survisland.all_together matches 1 run tag @s add survisland.all_together.left
execute if score @s survisland.all_together matches 2 run tag @s add survisland.all_together.left
...
execute if score @s survisland.all_together matches 1 run tag @s add survisland.all_together.right
execute if score @s survisland.all_together matches 2 run tag @s add survisland.all_together.right
...
execute if score @s survisland.all_together matches 1 run tag @s add survisland.all_together.jump
...
execute if score @s survisland.all_together matches 4 run tag @s add survisland.all_together.jump
execute if score @s survisland.all_together matches 1 run tag @s add survisland.all_together.sneak
execute if score @s survisland.all_together matches 2 run tag @s add survisland.all_together.sneak
execute if score @s survisland.all_together matches 3 run tag @s add survisland.all_together.sneak
execute if score @s survisland.all_together matches 4 run tag @s add survisland.all_together.sneak
execute if score @s survisland.all_together matches 1 run tag @s add survisland.all_together.sprint
execute if score @s survisland.all_together matches 2 run tag @s add survisland.all_together.sprint
execute if score @s survisland.all_together matches 3 run tag @s add survisland.all_together.sprint
execute if score @s survisland.all_together matches 4 run tag @s add survisland.all_together.sprint
...
execute if score @s survisland.all_together matches 3 run tag @s add survisland.all_together.look
...
execute if score @s survisland.all_together matches 4 run tag @s add survisland.all_together.click
...
title @s title {"text": "Prologue - Laboratoire", "color": "gold"}
title @s subtitle {"text": "Nouveau set de commandes", "color": "gray"}
tellraw @s [{"text": "\n"}, {"text": "Joueur 1 : ", "color": "yellow"}, {"text": "Avancer / Reculer / Marcher à gauche / Marcher à droite / Sauter / S'accroupir / Sprinter / Tourner la tête / Clic gauche / Clic droit\n", "color": "white"}, {"text": "Joueur 2 : ", "color": "yellow"}, {"text": "Avancer / Reculer / Marcher à gauche / Marcher à droite / Sauter / S'accroupir / Sprinter / Tourner la tête / Clic gauche / Clic droit\n", "color": "white"}, {"text": "Joueur 3 : ", "color": "yellow"}, {"text": "Avancer / Reculer / Marcher à gauche / Marcher à droite / Sauter / S'accroupir / Sprinter / Tourner la tête / Clic gauche / Clic droit\n", "color": "white"}, {"text": "Joueur 4 : ", "color": "yellow"}, {"text": "Avancer / Reculer / Marcher à gauche / Marcher à droite / Sauter / S'accroupir / Sprinter / Tourner la tête / Clic gauche / Clic droit\n", "color": "white"}]
