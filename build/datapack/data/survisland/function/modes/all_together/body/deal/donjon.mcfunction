...
#> survisland:modes/all_together/body/deal/donjon
#
# @executed	as @a[tag=survisland.all_together,distance=..50]
#
# @within	survisland:modes/all_together/body/set_phase/donjon [ as @a[tag=survisland.all_together,distance=..50] ]
#
...
title @s title {"text": "Partie 4 - Donjon", "color": "gold"}
