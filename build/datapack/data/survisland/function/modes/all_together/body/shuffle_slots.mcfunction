...
scoreboard players add @a[tag=survisland.all_together,distance=..3] survisland.all_together 1
scoreboard players set @a[tag=survisland.all_together,distance=..3,scores={survisland.all_together=5..}] survisland.all_together 1
