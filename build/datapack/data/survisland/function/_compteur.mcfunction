...
execute unless data storage survisland:main compteur run data modify storage survisland:main compteur set value {decompte:5,sounds:{xp:1b,goat_horn:1b,wither:0b},title:[{"translate": "survisland.lancement_de_lpreuve","color":"aqua"}]}
