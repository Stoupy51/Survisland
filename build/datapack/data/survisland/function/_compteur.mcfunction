...
#> survisland:_compteur
#
# @within	survisland:modes/marcus_truc_s9/start
#

scoreboard players set #compteur survisland.data 4

execute unless data storage survisland:main compteur run data modify storage survisland:main compteur set value {decompte:5,sounds:{xp:1b,goat_horn:1b,wither:0b},images:1b,title:[{"text":"Lancement de l'épreuve ","color":"aqua"}]}
...
execute store result score #compteur_images survisland.data run data get storage survisland:main compteur.images
