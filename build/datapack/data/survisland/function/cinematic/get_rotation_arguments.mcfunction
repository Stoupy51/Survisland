...
#> survisland:cinematic/get_rotation_arguments
#
# @within	???
#
...
execute store result score #current_yaw survisland.data run data get storage switch:temp current_rotation[0] 1000
execute store result score #target_yaw survisland.data run data get storage switch:temp target_rotation[0] 1000
...
execute store result storage switch:temp target_rotation[0] float 0.001 run scoreboard players get #target_yaw survisland.data
