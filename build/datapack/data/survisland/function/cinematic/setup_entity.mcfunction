...
execute store result storage switch:temp initial_points.step double 0.000001 run scoreboard players get #cinematic_step survisland.data
...
execute if score #cinematic_interpolation survisland.data matches ..2 run data modify storage bs:out spline.sample_bezier append from storage switch:temp target_position
execute if score #cinematic_interpolation survisland.data matches ..1 run data modify storage bs:out spline.sample_bezier append from storage switch:temp target_position
...
execute if score #cinematic_interpolation survisland.data matches ..2 run data modify storage bs:out spline.sample_bspline append from storage switch:temp target_rotation
execute if score #cinematic_interpolation survisland.data matches ..1 run data modify storage bs:out spline.sample_bspline append from storage switch:temp target_rotation
