...
execute at @e[type=marker,tag=survisland.moderate_adventure_zone] as @a[gamemode=!spectator,tag=!survisland.in_adv_zone,distance=..15] run function survisland:adventure_zone/enter
