...
#			survisland:adventure_zone/second [ at @e[type=marker,tag=survisland.moderate_adventure_zone] & as @a[gamemode=!spectator,tag=!survisland.in_adv_zone,distance=..15] ]
