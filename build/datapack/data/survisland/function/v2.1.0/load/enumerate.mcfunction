...
#> survisland:v2.1.0/load/enumerate
#
...
execute if score #survisland.major load.status matches 2 if score #survisland.minor load.status matches 1 unless score #survisland.patch load.status matches 0.. run scoreboard players set #survisland.patch load.status 0
