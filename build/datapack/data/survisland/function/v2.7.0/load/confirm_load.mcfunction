...
#> survisland:v2.7.0/load/confirm_load
#
# @within	survisland:v2.7.0/load/valid_dependencies
#

# Confirm load
tellraw @a[tag=convention.debug] {"text":"[Loaded Survisland v2.7.0]","color":"green"}
scoreboard players set #survisland.loaded load.status 1
function survisland:v2.7.0/load/set_items_storage
...
# Set scoreboard constants for survisland.data
