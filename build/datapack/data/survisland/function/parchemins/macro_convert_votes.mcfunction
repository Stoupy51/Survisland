...
#> survisland:parchemins/macro_convert_votes
#
# @within	Nothing
...
$execute if score #parchemin_count survisland.data matches 1.. run function survisland:parchemins/_convert_to_scroll {text_color:"$(text_color)", dyed_color:$(dyed_color)}
