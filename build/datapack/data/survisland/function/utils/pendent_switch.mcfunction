...
execute if data entity @s Inventory[{Slot:-106b}].components{"minecraft:item_model":"survisland:pendent"} run item replace block 0 5 0 container.0 from entity @s weapon.offhand
...
execute if data entity @s Inventory[{Slot:-106b}].components{"minecraft:item_model":"survisland:pendent"} run data modify block 0 5 0 Items[0].components."minecraft:item_model" set value "survisland:pendent_held"
...
execute if data entity @s Inventory[{Slot:-106b}].components{"minecraft:item_model":"survisland:pendent"} run item replace entity @s weapon.offhand from block 0 5 0 container.0
