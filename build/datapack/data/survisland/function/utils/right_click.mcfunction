...
execute if score #success survisland.data matches 0 store success score #success survisland.data if data entity @s SelectedItem.components{"minecraft:item_model":"survisland:cushion"} run function survisland:cushion/place
