...
#> survisland:v2.5.1/load/confirm_load
#
# @within	survisland:v2.5.1/load/valid_dependencies
#

# Confirm load
tellraw @a[tag=convention.debug] {"text":"[Loaded Survisland v2.5.1]","color":"green"}
scoreboard players set #survisland.loaded load.status 1
function survisland:v2.5.1/load/set_items_storage
